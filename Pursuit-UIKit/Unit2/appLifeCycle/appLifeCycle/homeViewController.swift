...
class homeViewController: UIViewController {
    ...
    /*
        ...
        iOS usually only calls this once, when the content view is created. We use this to perform any additional setup rerquired by our view, such as loadData, setting protocol extensions to self, updating UI.
    */
