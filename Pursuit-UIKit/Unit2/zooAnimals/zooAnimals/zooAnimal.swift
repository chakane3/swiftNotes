...
struct animals {
    ...
    // this is a property that  holds an array of our animals
    static let zooAnimal: [animals] = [
        animals(name: "Aardvark", imageNumber: 1, origin: "Africa", classification: "Mammal", info: """
...
"""),
        animals(name: "African Elephant", imageNumber: 2, origin: "Africa", classification: "Mammal", info: """
...
"""),
        animals(name: "Anaconda Snake", imageNumber: 3, origin: "South America", classification: "Amphibian", info: """
...
"""),
        animals(name: "Alligator", imageNumber: 4, origin: "North America, Asia", classification: "Reptile", info: """
...
"""),
        animals(name: "Bison", imageNumber: 5, origin: "North America", classification: "Mammal", info: """
...
"""),
        animals(name: "Bumblebee", imageNumber: 6, origin: "Unknown", classification: "Insect", info: """
...
"""),
        animals(name: "Butterfly", imageNumber: 7, origin: "Unknown", classification: "Insect", info: """
...
"""),
        animals(name: "Camel", imageNumber: 8, origin: "Africa, Asia", classification: "Mammal", info: """
...
"""),
        animals(name: "Cheetah", imageNumber: 9, origin: "Africa", classification: "Mammal", info: """
...
"""),
        animals(name: "Dolphin", imageNumber: 10, origin: "Unknown", classification: "Mammal", info: """
...
"""),
        animals(name: "Penguin", imageNumber: 11, origin: "Antarctica", classification: "Bird", info: """
...
"""),
        animals(name: "Flamingo", imageNumber: 12, origin: "South America", classification: "Bird", info: """
...
"""),
        animals(name: "Panda Bear", imageNumber: 13, origin: "Asia", classification: "Mammal", info: """
...
"""),
        animals(name: "Gorilla", imageNumber: 14, origin: "Africa", classification: "Mammal", info: """
...
"""),
        animals(name: "Komodo Dragon", imageNumber: 15, origin: "Asia", classification: "Reptile", info: """
...
"""),
        animals(name: "Tortoise", imageNumber: 16, origin: "Africa", classification: "Reptile", info: """
...
"""),
        animals(name: "Toucan", imageNumber: 17, origin: "Africa", classification: "Bird", info: """
...
"""),
        animals(name: "Eagle", imageNumber: 18, origin: "North America", classification: "Bird", info: """
...
"""),
        animals(name: "Beetle", imageNumber: 19, origin: "Unknown", classification: "Insect", info: """
...
"""),
        animals(name: "Zebras", imageNumber: 20, origin: "Africa", classification: "Mammal", info: """
...
""")
    ...
    // here we hae a function to turn our data into an n-d array based on the classification of animal
    static func classificationSections() -> [[animals]] {
        // sort animals by classification
        let sortedZooAnimals = zooAnimal.sorted {$0.classification < $1.classification}
        
        // use a set to get unique values
        let uniqueClassifications = Set(sortedZooAnimals.map {$0.classification})
        
        // create an empty n-d array to represent how many sections we will have
        // this will look similar to: [[animals], [animals], [animals], ... []]
        var sections = Array(repeating: [animals](), count: uniqueClassifications.count)
        
        // create an initial starting index for the sections
        var currentIndex = 0
        
        // get the current classification name
        var currentClassification = sortedZooAnimals.first?.classification ?? "Semper fidelis"
        
        // loop over sortedZooAnimals and place it in the appropriate section
